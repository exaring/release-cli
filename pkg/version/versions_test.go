...
func TestVersions_Less(t *testing.T) {
	tt := []struct {
		...
		{[]string{"2.1.1-RC1", "1.1.1-RC2"}, false},
		{[]string{"0.1.0-RC2", "0.2.0"}, true},
		{[]string{"0.1.0-RC2", "0.1.0"}, true},
		{[]string{"0.4.0", "0.1.0-RC1"}, false},
		{[]string{"0.1.0-RC1", "0.5.0-RC2"}, true},
		{[]string{"1.1.1-RC1", "1.1.1-RC10"}, true},
		{[]string{"1.1.1-RC1", "1.1.1"}, true},
		{[]string{"1.1.1", "1.1.1-RC1"}, false},
		{[]string{"1.1.1-RC1", "1.1.1-RC10"}, true},
		{[]string{"1.1.1-RC10", "1.1.1-RC1"}, false},
		{[]string{"1.1.1-RC1", "1.1.2"}, true},
		{[]string{"1.1.2", "1.1.1-RC1"}, false},
		{[]string{"1.0.0", "0.1.1-RC1"}, false},
		{[]string{"0.1.1-RC1", "1.0.0"}, true},
	}
